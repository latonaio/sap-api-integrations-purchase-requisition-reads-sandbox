...
type Header struct {
	...
	ToItem                  string `json:"to_PurchaseReqnItem"`
}
...
type Item struct {
	...
	ToItemDeliveryAddress          string `json:"to_PurchaseReqnDeliveryAddress"`
	ToItemAccount                  string `json:"to_PurchaseReqnAcctAssgmt"`
}
